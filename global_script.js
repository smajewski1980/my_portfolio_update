...
window.addEventListener('resize', () => {
  ...
  if (getInnerWidth() < 1200) {
    ltFlame4.innerHTML = '';
    rtFlame4.innerHTML = '';
    ltFlame4Rear.innerHTML = '';
    rtFlame4Rear.innerHTML = '';
    ltFl4Wrapper.classList.remove('front-fade-in');
    rtFl4Wrapper.classList.remove('front-fade-in');
    ltFl4WrapperRear.classList.remove('rear-fade-in');
    rtFl4WrapperRear.classList.remove('rear-fade-in');
    fireLoop3.volume = 0;
  }
});
